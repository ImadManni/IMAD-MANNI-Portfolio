...
const socialLinks = [
    {
      href: 'https://github.com/ImadManni',
    ...
    {
      href: 'https://linkedin.com/in/imadmanni/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/imad.manni/',
  ...
  return (
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-10 lg:flex lg:flex-col">
            ...
            <form action="https://getform.io/f/byvvxmza" method="post" className="">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                <div className="mb-4">
                        <label htmlFor="email" className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            Email
                        </label>
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="imad@example.com" className="text-field" />
                    </div>
                <div className="mb-4">
                        <label htmlFor="name" className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Imad Manni" className="text-field" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="message" className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            Message
                        </label>
                        <textarea
                        name="message"
